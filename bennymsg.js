...
*Provider :* INDIHOME ASU`, id)
	...
	if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
	      client.sendStickerfromUrl(dari, `https://arugaz.my.id/api/textpro/foilballoon?text=${body.slice(13)}`, 'daun.jpg', 'Anjay bah', id)
		  break
	case '#stickmatrix':
		if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
	...
	case '#sticklava':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const lavanya = `https://arugaz.my.id/api/textpro/lavatext?text=${body.slice(10)}`
	...
	case '#stickracun':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
	    const racunnya = `https://arugaz.my.id/api/textpro/toxictext?text=${body.slice(11)}`
	...
	case '#stickbokeh':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const bokehnya = `https://arugaz.my.id/api/textpro/bokehtext?text=${body.slice(11)}`
	...
	case '#stickgneon':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const gneonnya = `https://arugaz.my.id/api/textpro/greenneon?text=${body.slice(11)}`
	...
	case '#stickholo':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const holonyai = `https://arugaz.my.id/api/textpro/holographic?text=${body.slice(10)}`
	...
	case '#stickglue':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const gluenyaj = `https://arugaz.my.id/api/textpro/glue3d?text=${body.slice(10)}`
	...
	case '#stick3d':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			const gbrnyi = `https://arugaz.my.id/api/textpro/text3d?text=${textnyi}`
	...
	case '#stickbp':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			const bpnyi = `https://arugaz.my.id/api/textpro/blackpink?text=${textnyu}`
	...
	case '#stickglitch':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
            arg = body.trim().split('|')
			client.reply(dari, mess.wait, id)
			const glitchnyi = `https://arugaz.my.id/api/textpro/glitchtext?text1=${arg[1]}&text2=${arg[2]}`
	...
	case '#sticktahta':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			client.reply(dari, mess.wait, id)
			const tahtalu = arg[1]
	        client.sendStickerfromUrl(dari, `https://api.vhtear.com/hartatahta?text=${tahtalu}&apikey=GuaGanti`)
			break
	case '#stickwolf':
		if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
...
case '#stickff':
	...
	case '#stickgoogle':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
		 ...
		 client.reply(dari, mess.wait, id)
		 arg = body.trim().split('|')
		 const googlenyas = `https://api.vhtear.com/googletext?text1=${arg[1]}&text2=${arg[2]}&text3=${arg[3]}&apikey=GuaGanti`
	...
	case '#stickmetal':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const metalnyas = `https://arugaz.my.id/api/textpro/metaldark?text=${body.slice(12)}`
	...
	case '#stickwroom':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const wroomnyas = `https://arugaz.my.id/api/flamingtext/wroom?text=${body.slice(12)}`
	...
	case '#stick3d2':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const t3d2nyas = `https://arugaz.my.id/api/flamingtext/text3d?text=${body.slice(10)}`
	...
	case '#stickfwater':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const fwaternyas = `https://arugaz.my.id/api/flamingtext/water?text=${body.slice(12)}`
	...
	case '#stickbird':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const birdnyas = `https://arugaz.my.id/api/flamingtext/blackbird?text=${body.slice(11)}`
	...
	case '#sticksmurf':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const smurfnyas = `https://arugaz.my.id/api/flamingtext/smurf?text=${body.slice(12)}`
	...
	case '#stickerml':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
	     ...
	     arg = body.trim().split('|')
		 const textmls = arg[2]
		 const mlnyas = `https://api.vhtear.com/logoml?hero=arg[1]&text=${textmls}&apikey=GuaGanti`
	...
	case '#stickermemo':
       ...
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		client.reply(dari, mess.wait, id)
		arg = body.trim().split('|')
		const smemonya = `https://arugaz.my.id/api/flamingtext/memories?text=${body.slice(11)}`
	...
	if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
				if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
	    client.reply(dari, mess.wait, id)
		const tahtanya = `https://api.vhtear.com/hartatahta?text=${body.slice(7)}&apikey=GuaGanti`
	...
	if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
	     client.reply(dari, mess.wait, id)
		 client.sendFileFromUrl(dari, `https://arugaz.my.id/api/textpro/foilballoon?text=${body.slice(12)}`, 'daun.jpg', 'Anjay bah', id)
		  break
	case '#textmatrix':
	case '#teksmatrix':
		if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			client.reply(dari, mess.wait, id)
			const matrixnya = `https://naufalhoster.xyz/textmaker/matrix?apikey=john-doe&text=${body.slice(12)}`
	...
	case '#tekspetir':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			const petirnya = await fetch(`https://api.zeks.xyz/api/thundertext?text=${textnye}&apikey=apivinz`)
			const petirna = await petirnya.json()
			client.sendFileFromUrl(dari, petirna.result, '', 'Anjay bah', id)
            break
	case '#textlava':
	case '#tekslava':
		if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const lavanyaa = `https://arugaz.my.id/api/textpro/lavatext?text=${body.slice(10)}`
	...
	case '#teksequal':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const equalnyab = `ttps://arugaz.my.id/api/textpro/equalizer?text=${body.slice(11)}`
	...
	case '#teksracun':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
	    const racunnyac = `https://arugaz.my.id/api/textpro/toxictext?text=${body.slice(11)}`
	...
	case '#teksbokeh':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const bokehnyad = `https://arugaz.my.id/api/textpro/bokehtext?text=${body.slice(11)}`
	...
	case '#teksgneon':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const gneonnyae = `https://arugaz.my.id/api/textpro/greenneon?text=${body.slice(11)}`
	...
	case '#teksold':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const oldnya = `https://arugaz.my.id/api/textpro/old1917?text=${body.slice(9)}`
	...
	case '#teksholo':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const holonya = `https://arugaz.my.id/api/textpro/holographic?text=${body.slice(10)}`
	...
	case '#teksglue':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			if (args.length === 1) return client.reply(dari, 'Teksnya mana??', id)
			client.reply(dari, mess.wait, id)
			const gluenya = `https://arugaz.my.id/api/textpro/glue3d?text=${body.slice(10)}`
	...
	case '#teks3d':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			const gbrnya = `https://arugaz.my.id/api/flamingtext/text3d?text=${textnya}`
	...
	case '#teksbp':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
			...
			const bpnya = `https://arugaz.my.id/api/textpro/blackpink?text=${textnyo}`
	...
	case '#teksph':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
          ...
          arg = body.trim().split('|')
			client.reply(dari, mess.wait, id)
		 const phnya = `https://naufalhoster.xyz/textmaker/pornhub?apikey=john-doe&text1=${arg[0]}&text2=${arg[1]}`
	...
	case '#teksneon':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
            if (args.length === 0) return client.reply(dari, 'Teksnya mana ??', id)
			client.reply(dari, mess.wait, id)
			const neonnya = `https://arugaz.my.id/api/textpro/neontext?text=${body.slice(10)}`
	...
	case '#ttg':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
                 client.reply(dari, mess.wait, id)
                await client.sendStickerfromUrl(dari, `https://api.vhtear.com/textxgif?text=${body.slice(5)}&apikey=GuaGanti`)
     ...
     case '#emojistiker':
		       ...
		       if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
                client.reply(dari, mess.wait, id)
                    ...
                    client.sendStickerfromUrl(dari, "https://api.vhtear.com/emojitopng?code=" + bjbjbja + "&apikey=" + "GuaGanti")
                    break
	case '#textff':
	case '#teksff':
	    if (isAfk) return await client.reply(dari, `Maaf ${pushname}, Kamu sedang afk! Ketik #unafk untuk mematikan`, id)
	...
	case '#textgoogle':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
		 ...
		 client.reply(dari, mess.wait, id)
		 arg = body.trim().split('|')
		 const googlenya = `https://api.vhtear.com/googletext?text1=${arg[1]}&text2=${arg[2]}&text3=${arg[3]}&apikey=GuaGanti`
	...
	case '#teksml':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
		 ...
		 client.reply(dari, mess.wait, id)
		 arg = body.trim().split('|')
		 const mlnya = `https://api.vhtear.com/logoml?hero=${arg[1]}&text=${arg[2]}&apikey=GuaGanti`
	...
	case '#teksdarah':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
         if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		 client.reply(dari, mess.wait, id)
		 const darah = `https://naufalhoster.xyz/textmaker/blood?apikey=john-doe&text=${body.slice(11)}`
	...
	case '#teksmetal':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const metalnya = `https://arugaz.my.id/api/textpro/metaldark?text=${body.slice(11)}`
	...
	case '#teksfwater':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const fwaternya = `ttps://arugaz.my.id/api/flamingtext/water?text=${body.slice(12)}`
	...
	case '#tekssmurf':
		...
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
       if (args.length === 1) return client.reply(dari, 'Teks nya mana??', id)
		const smurfnya = `https://arugaz.my.id/api/flamingtext/smurf?text=${body.slice(11)}`
    ...
    /* case '#bokep':
		if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
          client.reply(dari, mess.wait, id)
          const bokap = await axios.get(`https://api.vhtear.com/xxxsearch?query=${body.slice(7)}&apikey=GuaGanti`)
    ...
    case '#nekopoi':
	      if (!isRegistered) return await client.reply(dari, `Nomor kamu belum terdafar! \n\nSilahkan register dengan format:\n *#daftar*`, id)
          client.reply(dari, mess.wait, id)
          const boke = await fetch(`https://arugaz.my.id/api/anime/nekopoi/random`)
